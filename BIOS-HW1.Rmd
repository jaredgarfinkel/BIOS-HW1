...
Systolic Blood Pressure (mm Hg) | `r round(mean(df_good$PRE), digits = 2)` +/- `r round(sd(df_good$PRE), digits = 2)` | `r round(mean(df_good$PRE), digits = 2)`+/- `r round(sd(df_good$PRE), digits = 2)` | `r round(mean(df_good$POST), digits = 2)` +/- `r round(sd(df_good$POST), digits = 2)` | `r round(mean(df_good$POST), digits = 2)`+/- `r round(sd(df_good$POST), digits = 2)`