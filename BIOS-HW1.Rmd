...
HDL Cholesterol | `r round(mean(pull(new_df1,PRE.3)), digits = 2)` +/- `r round(sd(pull(new_df1,PRE.3)), digits = 2)` | `r round(mean(pull(new_df1,POST.3)), digits = 2)` +/- `r round(sd(pull(new_df1,POST.3)), digits = 2)` | `r round(mean(pull(new_df2,PRE.3)), digits = 2)` +/- `r round(sd(pull(new_df2,PRE.3)), digits = 2)` | `r round(mean(pull(new_df2,POST.3)), digits = 2)` +/- `r round(sd(pull(new_df2,POST.3)), digits = 2)`
...
LDL Cholesterol | `r round(mean(pull(new_df1,PRE.4)), digits = 2)` +/- `r round(sd(pull(new_df1,PRE.4)), digits = 2)` | `r round(mean(pull(new_df1,POST.4)), digits = 2)` +/- `r round(sd(pull(new_df1,POST.4)), digits = 2)` | `r round(mean(pull(new_df2,PRE.4)), digits = 2)` +/- `r round(sd(pull(new_df2,PRE.4)), digits = 2)` | `r round(mean(pull(new_df2,POST.4)), digits = 2)` +/- `r round(sd(pull(new_df2,POST.4)), digits = 2)`
