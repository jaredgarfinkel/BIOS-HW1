...
```{r table2}
solution2a <- tableby(Group ~ PRE + POST + PRE.1 + POST.1 + PRE.2 + POST.2 + PRE.3 + POST.3 + PRE.4 + POST.4 + PRE.5 + POST.5,
...
```{r solution2a}
summary(solution2a, title="Metabolic Parameters", labelTranslations = my_labels2, text=TRUE)
```
